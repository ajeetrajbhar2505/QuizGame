...
const Header = class {
  constructor(hostRef) {
    ...
    this.setupFadeHeader = /*#__PURE__*/function () {
      var _ref4 = (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl, condenseHeader) {
        const scrollEl = _this10.scrollEl = yield (0,_index_BlJTBdxG_js__WEBPACK_IMPORTED_MODULE_6__.g)(contentEl);
        /**
         * Handle fading of toolbars on scroll
         */
  ...
  checkCollapsibleHeader() {
    var _this11 = this;
    return (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const mode = (0,_index_B_U9CtaY_js__WEBPACK_IMPORTED_MODULE_1__.e)(_this11);
      if (mode !== 'ios') {
        return;
      }
      const {
      ...
      if (hasCondense) {
        ...
        const contentEl = pageEl ? (0,_index_BlJTBdxG_js__WEBPACK_IMPORTED_MODULE_6__.a)(pageEl) : null;
        if (!contentEl) {
          (0,_index_BlJTBdxG_js__WEBPACK_IMPORTED_MODULE_6__.p)(_this11.el);
          return;
        }
  ...
  setupCondenseHeader(contentEl, pageEl) {
    ...
    return (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!contentEl || !pageEl) {
        (0,_index_BlJTBdxG_js__WEBPACK_IMPORTED_MODULE_6__.p)(_this12.el);
        return;
      }
      if (typeof IntersectionObserver === 'undefined') {
        return;
      }
      _this12.scrollEl = yield (0,_index_BlJTBdxG_js__WEBPACK_IMPORTED_MODULE_6__.g)(contentEl);
...
const RouterOutlet = class {
  ...
  connectedCallback() {
    ...
    return (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this13.gesture = (yield __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ./swipe-back-VdaUzLWy.js */ 9019))).createSwipeBackGesture(_this13.el, () => !_this13.gestureOrAnimationInProgress && !!_this13.swipeHandler && _this13.swipeHandler.canStart(), () => onStart(), step => {
        var _a;
  ...
  setRoot(component, params, opts) {
    var _this17 = this;
    return (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this17.activeComponent === component && (0,_helpers_1O4D2b7y_js__WEBPACK_IMPORTED_MODULE_3__.s)(params, _this17.activeParams)) {
        return false;
      }
      // attach entering view to DOM
      const leavingEl = _this17.activeEl;
      const enteringEl = yield (0,_framework_delegate_DxcnWic_js__WEBPACK_IMPORTED_MODULE_9__.a)(_this17.delegate, _this17.el, component, ['ion-page', 'ion-page-invisible'], params);
      ...
      yield (0,_framework_delegate_DxcnWic_js__WEBPACK_IMPORTED_MODULE_9__.d)(_this17.delegate, leavingEl);
      return true;
    })();
  }
  transition(enteringEl, leavingEl, opts = {}) {
    ...
    return (0,_Users_ajeetrajbhar_Documents_QuizGame_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const animated = _this18.animated && _index_B_U9CtaY_js__WEBPACK_IMPORTED_MODULE_1__.l.getBoolean('animated', true);
      const animationBuilder = opts.animationBuilder || _this18.animation || _index_B_U9CtaY_js__WEBPACK_IMPORTED_MODULE_1__.l.get('navAnimation');
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_ion-app_8_entry_js.b52ca3eeb3130bde.js.map